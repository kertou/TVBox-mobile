...
import com.github.tvbox.osc.cache.DownloadEpisodeDao;
 ...
 * @since 2020/5/15
 */
@Database(entities = {Cache.class, VodRecord.class, VodCollect.class, DownloadEpisode.class}, version = 2)
public abstract class AppDataBase extends RoomDatabase {
    ...
    public abstract DownloadEpisodeDao getDownloadEpisodeDao();
}
